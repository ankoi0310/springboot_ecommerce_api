...
import com.koi.ecommerce.filter.JwtAccessDeniedHandler;
import com.koi.ecommerce.filter.JwtAuhenticationEntryPoint;
import com.koi.ecommerce.filter.JwtAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(@Qualifier("myUserDetailsService")UserDetailsService userDetailsService,
                          BCryptPasswordEncoder bCryptPasswordEncoder, JwtAuthorizationFilter jwtAuthorizationFilter,
                          JwtAccessDeniedHandler jwtAccessDeniedHandler, JwtAuhenticationEntryPoint jwtAuthenticationEntryPoint) {
